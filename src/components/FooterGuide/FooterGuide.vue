<template>
  <footer>
    ...
    <span class="guide_item" @click="goto('/fangle')">
      <i class="tabBar fangle" :class="{on: isCurrent('/fangle')}"></i>
      <span class="txt" :class="{on: isCurrent('/fangle')}">识物</span>
    </span>
    <span class="guide_item" @click="goto('/item')">
      <i class="tabBar item" :class="{on: isCurrent('/item')}"></i>
      <span class="txt" :class="{on: isCurrent('/item')}">分类</span>
    </span>
